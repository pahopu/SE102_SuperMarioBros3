...
#define OBJECT_TYPE_MUSHROOM_SUPER						6
#define OBJECT_TYPE_MUSHROOM_1UP						7
#define OBJECT_TYPE_SUPER_LEAF							8
...
#define ID_SPRITE_MARIO_RACOON_FLY						(ID_SPRITE_MARIO_RACOON + 900)

#define ID_SPRITE_MARIO_RACOON_FLY_UP					(ID_SPRITE_MARIO_RACOON_FLY + 10)
#define ID_SPRITE_MARIO_RACOON_FLY_UP_LEFT				(ID_SPRITE_MARIO_RACOON_FLY_UP + 1)
#define ID_SPRITE_MARIO_RACOON_FLY_UP_RIGHT				(ID_SPRITE_MARIO_RACOON_FLY_UP + 4)

#define ID_SPRITE_MARIO_RACOON_FLY_DOWN					(ID_SPRITE_MARIO_RACOON_FLY + 20)
#define ID_SPRITE_MARIO_RACOON_FLY_DOWN_LEFT			(ID_SPRITE_MARIO_RACOON_FLY_DOWN + 1)
#define ID_SPRITE_MARIO_RACOON_FLY_DOWN_RIGHT			(ID_SPRITE_MARIO_RACOON_FLY_DOWN + 3)
...
#define ID_SPRITE_SUPER_LEAF							(ID_SPRITE_MUSHROOM + 3000)

#define ID_SPRITE_KOOPA_TROOPA							70000
#define ID_SPRITE_KOOPA_TROOPA_WALK						(ID_SPRITE_KOOPA_TROOPA + 1000)
#define ID_SPRITE_KOOPA_TROOPA_SHELL					(ID_SPRITE_KOOPA_TROOPA + 2000)
